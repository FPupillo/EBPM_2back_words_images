...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\r01fp16\\OneDrive - University of Aberdeen\\prospective memory\\Valence Arousal stud\\pictures and words\\Task\\PM1_lastrun.py',
...
text_44 = visual.TextStim(win=win, name='text_44',
    text='You are now going to see the images and the words that you had to remember once again. \n\nFor each of them, please rate the valence (positive vs negative) and the arousal (excited vs calm) of each word and image. \n\nPress {Space} to start.  ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=1.5, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisFinalLoop in finalLoop:
    ...
    SAMratings = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(cueRatings),
