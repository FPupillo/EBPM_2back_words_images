...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\r01fp16\\OneDrive - University of Aberdeen\\prospective memory\\Valence Arousal stud\\pictures and words\\Task\\PM1.py',
...
text_7 = visual.TextStim(win=win, name='text_7',
    text='Please fill the first questionnaire (PANAS). \n\nWhen finished:\nPlese press {SPACE} to continue. ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=2, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_17 = visual.TextStim(win=win, name='text_17',
    text='Please fill in questionnaire 2 (HADS)\nand 3 (PSS).\n\nAttention: The HADS has 2 pages!\n\n\nWhen finished:\npress {SPACE} to continue. ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=1.5, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_18 = visual.TextStim(win=win, name='text_18',
    text='You will now engage in the task. \n\nPlease place your left finger on the {D} butto and the right finger on the {L} button. \n\n\nPress {SPACE} to continue. ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=1.5, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisSkip_routine in skip_routine:
    ...
    # keep track of which components have finished
    instructions2Components = [text_7, key_resp_9]
...
for thisGroup in Group:
    ...
    # keep track of which components have finished
    PMintroComponents = [text_18, key_resp_17]
...
for thisFinalLoop in finalLoop:
    ...
    SAMratings = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Cues.xlsx'),
    ...
    for thisSAMrating in SAMratings:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        image_1.setImage(file)
        slider_valence.reset()
        key_resp_28 = event.BuilderKeyResponse()
        # keep track of which components have finished
        ValenceComponents = [image_1, ValenceImg, slider_valence, text_40, key_resp_28, text_41]
        ...
        # keep track of which components have finished
        ArousalComponents = [image_2, Arousalimage, slider_arousal, text_42, key_resp_29, text_43]
